...
if(isset($_POST['filter']))
{
    ...
    $query = "SELECT * FROM `blood_bank` WHERE CONCAT(`name`, `units_ap`, `units_an`, `units_bp`, `units_bn`, `units_abp`, `units_abn`, `units_op`, `units_on`, `email`, `number1`, `street`, `landmark`, `city`, `state`, `price`, `delivery`) LIKE '%".$value."%'";
...
<html>
    ...
    <body class="c2">
        ...
        <form action="Blood_Bank_data.php" method="post">
             <center> <h3> Filter By Location/Blood Group/Hospital Name etc.</h3></center>
